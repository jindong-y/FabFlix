package edu.uci.ics.jindongy.service.gateway.connectionpool;
...
public class ConnectionPoolManager {
    ...
    public Connection requestCon() throws SQLException {
        ...
        ServiceLogger.LOGGER.info("Request Connection");
    ...
    public void releaseCon(Connection con) {
        ServiceLogger.LOGGER.info("Release Connection");
        try {
            con.close();
        } catch (SQLException throwables) {
            ServiceLogger.LOGGER.severe(throwables.toString());
            ServiceLogger.LOGGER.severe("Release connection error");
        }
